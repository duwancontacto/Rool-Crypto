...
export default function Repartidores() {
    ...
    return (
        <>
            <h3 className='text-[40px] font-bold  text-[#f6bd60]  font-titulo text-center'>REPARTIDORES</h3>
                ...
                <div className="w-[18rem] h-[25rem] overflow-hidden  m-5 z-[99]" >
                    <div className={`flex relative transition-all duration-500 `} style={{ left: `-${step * 18}rem` }}>
                        ...
                        <div className={`${position === 1 ? "flex" : "hidden"}`}>
                            ...
                            <img src={repartidor1} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor2} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor3} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor4} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor5} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor6} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor7} className="w-[17rem] mx-2 rounded-full" />
                        </div>

                        <div className={`${position === 2 ? "flex" : "hidden"}`}>

                            <img src={repartidor1b} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor2b} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor3b} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor4b} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor5b} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor6b} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor7b} className="w-[17rem] mx-2 rounded-full" />
                        ...
                        <div className={`${position === 3 ? "flex" : "hidden"}`}>
                            ...
                            <img src={repartidor1a} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor2a} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor3a} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor4a} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor5a} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor6a} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor7a} className="w-[17rem] mx-2 rounded-full" />
                        </div>
                        ...
                        <div className={`${position === 4 ? "flex" : "hidden"}`}>
                            ...
                            <img src={repartidor1c} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor2c} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor3c} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor4c} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor5c} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor6c} className="w-[17rem] mx-2 rounded-full" />
                            <img src={repartidor7c} className="w-[17rem] mx-2 rounded-full" />
